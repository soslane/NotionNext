...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bbs.myla.eu.org', // 网站地址
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://img.myla.eu.org/api/file/ad9308e6b3653ffe18d1a.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  PRISM_THEME_PREFIX_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_PREFIX_PATH || 'https://cdn.jsdelivr.net/gh/PrismJS/prism-themes/themes/prism-base16-ateliersulphurpool.light.css', // 代码块默认主题
