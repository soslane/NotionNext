...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Less is more', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://myla.eu.org', // 网站地址
  ...
  RANDOM_IMAGE_URL: process.env.NEXT_PUBLIC_RANDOM_IMAGE_URL || 'https://pic.myla.eu.org/file/1729565505766_cover_466915.png', // 随机图片API,如果未配置下面的关键字，主页封面，头像，文章封面图都会被替换为随机图片
  ...
  PRISM_THEME_PREFIX_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_PREFIX_PATH || 'https://cdn.jsdelivr.net/gh/PrismJS/prism-themes/themes/prism-z-touch.css', // 代码块默认主题
